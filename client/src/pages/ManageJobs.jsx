...
const ManageJobs = () => {
  ...
  // funtion to change visibility
  const changJobVisibility = async (id) => {
    try {
        ...
        <table className='min-w-full bg-white border border-gray-200 max-sm:text-sm'>
          <thead>
            <tr>
              ...
              <th className='py-2 px-4 border-b text-left'>Jot Title</th>
            ...
            {jobs.map((job, index) => (
              <tr key={index} className='text-gray-700'>
                ...
                <td className='py-2 px-4 border-b'>
                  <input onChange={() => changJobVisibility(job._id)} className='scale-125 ml-4' type="checkbox" checked={job.visible} />
                </td>
              </tr>
            ))}
          </tbody>
