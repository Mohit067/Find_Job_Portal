...
const RecruiterLogin = () => {
  ...
  const {setShowRucruiterLogin, backendUrl, setCompanyToken, setCompanyData} = useContext(AppContext);
  ...
  return (
    <div className="absolute top-0 left-0 right-0 bottom-0 z-10 backdrop-blur-sm bg-black/30 flex justify-center items-center">
      <form onSubmit={handleSubmit} className="relative bg-white p-10 rounded-xl text-slate-500">
        ...
        <img onClick={() => setShowRucruiterLogin(false)} className="absolute top-5 right-5 cursor-pointer" src={assets.cross_icon} alt="" />
      </form>
    </div>
  );
};
